describe("Test 6", () => {
  it("will test that the pokemon cards have the correct background color / class", () => {
    ...
    cy.get('.pokemon-card.type-grass')
      .should('have.css', 'background-color', 'rgb(120, 200, 80)');
    ...
    cy.get('.pokemon-card.type-fire')
      .should('have.css', 'background-color', 'rgb(240, 128, 48)');
